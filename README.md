# Chickadee Tech Acro Polystack Mod #
This mod simply passes signals through and tries to leave room for neighboring mods. It is not in active production because no other mods use the extra space.

## Documentation ##
See the [wiki](https://github.com/chickadee-tech/pt/wiki) for documentation.
...
### Derivatives ###
If developing your own version of the passthrough board please remove all Chickadee Tech trademarks and follow the [CC-BY license](LICENSE). While not required, please consider open sourcing your modifications so others can learn from your improvements. If you do email support@chickadee.tech and we may choose to add your project to the ACD.
